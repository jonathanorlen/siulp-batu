                    ...
                    <div class="pageheader">
                        ...
                        <div class="page-bar">
                            ...
                            <ul class="page-breadcrumb">
                                <li>
                                    <a href="<?php echo base_url().'admin/dasboard'?>"><i class="fa fa-home">&nbsp</i>Data Paket Lelang</a>
                                </li>
                                <li>
                                    <a>Data Paket Lelang</a>
                                </li>
                                <li>
                                    <a href="<?php echo base_url() . 'admin/create_paket/content'?>">Data Paket</a>
                                </li>
                                <li>
                                    <a href="#" >Detail Paket</a>
                                </li>
                            </ul>
                            ...
                            <section class="tile">
                                ...
                                <div class="tile-body">
                                    ...
                                    <label class="col-sm-2 control-label">No RUP *</label>
                                        <div class="col-sm-8">
                                            <input readonly type="text" value="<?php echo @$hasil_data->no_rup;?>" name="no_rup" class="form-control" placeholder="No RUP"
                                ...
                                <div class="form-group">
                                    <label class="col-sm-2 control-label">Terbit Surat Perintah Tugas *</label>
                                    <div class="col-sm-8">
                                        <a onclick="cetak()" title="Terbit Surat Perintah Tugas" id="cetak" class="btn btn-primary bg-greensea"><i class="fa fa-mail-forward"></i> Terbit Surat Perintah Tugas</a>
                                ...
                                <?php
                                if($user->kode_jabatan=="001"){
                                    if($hasil_data->nomor_surat_sekretariat!=""){

                                        ?>

                                        <div class="form-group">
                                            <label class="col-sm-2 control-label">Kirim Email Surat Perintah Tugas *</label>
                                            <div class="col-sm-8">
                                                <a onclick="send_email()" title="Kirim Email Surat Perintah Tugas " id="cetak" class="btn btn-md bg-red"><i class="fa fa-send"></i> Kirim Email Surat Perintah Tugas </a>
