                                ...
                                <table style="font-size: small;" class="table table-hover table-custom dt-responsive" id="responsive-usage">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            <td>7</td>
                                            <td>RKS</td>
                                            <td><center><input type="checkbox" value="rks" name="hardcopy[]"></center></td>
                                            <td>
                                                <center>
                                                    <input type="checkbox" <?php
                                                    $this->db->select_max('id');
                                                    ...
                                                    $rks = $this->db->get_where('dokumen_paket',array('id'=>$hasil_cek_dokumen_rks->id));
                                                    $hasil_rks = $rks->row();
                                                    if($hasil_rks){echo 'checked';} ?> value="rks" name="softcopy[]">
                                        ...
                                        <tr>
                                            <td>9</td>
                                            <td>Time Schedule</td>
                                            <td><center><input type="checkbox" value="ts" name="hardcopy[]"></center></td>
                                            <td>
                                                <center>
                                                    <input type="checkbox" <?php
                                                    $this->db->select_max('id');
                                                    ...
                                                    $ts = $this->db->get_where('dokumen_paket',array('id'=>$hasil_cek_dokumen_ts->id));
                                                    $hasil_ts = $ts->row();
                                                    if($hasil_ts){echo 'checked';} ?> value="ts" name="softcopy[]">
                                        ...
                                        <tr>
                                            ...
                                            <td><center><input type="checkbox" value="sp" name="hardcopy[]"></center></td>
                                            <td><center><input type="checkbox" value="sp" name="softcopy[]"></center></td>
                                        </tr>
                                    </tbody>
