...
<body onload="window.print()"">
  ...
  <div style="width:97%;float:right;">
    ...
    <br>
    <br>
    <div style="font-size:15px;margin-bottom:5px">Kelengkapan dokumen <span style="font-weight:bold">jasa konsultasi</span> yang diterima tanggal <?php echo tanggalindo(date("Y-m-m"))?></div>
    <table style="width:100%;border-collapse:collapse;" border="1px">
      <tr>
      <?php if($hasil_ambil_data->posisi == "Revisi Dokumen"){?>
        <td style="width:50%;font-size:17px;padding:5px">DILENGKAPI KEMBALI</td>
