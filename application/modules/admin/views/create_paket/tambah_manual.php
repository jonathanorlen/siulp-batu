                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <section class="tile">
                                ...
                                <div class="tile-body">
                                    ...
                                    <form class="form-horizontal" name="data_form" role="form" method="post" enctype="multipart/form-data" id="data_form" data-parsley-validate action="<?php echo base_url().'admin/create_paket/simpan_tambah';?>" >
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-8">
                                             <input  id="nama_paket" type="text" name="nama_paket" class="form-control" placeholder="Nama Paket"
                                ...
                                <div class="form-group">
                                    <label class="col-sm-2 control-label">Bulan Rencana Pengadaan *</label>
                                    <div class="col-sm-8" >
                                        <select class="form-control" id="tanggal_rencana_pengadaan" name="tanggal_rencana_pengadaan" required>
                                            <option value="" selected="true">Pilih Bulan</option>
                                            <option value="01">Januari</option>
                                            <option value="02">Februari</option>
                                            <option value="03">Maret</option>
                                ...
                                <hr class="line-dashed line-full" />
                                <div class="form-group">
                                    <label class="col-sm-2 control-label">Bulan Rencana Pengerjaan *</label>
                                    <div class="col-sm-8" >
                                        <select class="form-control" id="tanggal_rencana_pekerjaan" name="tanggal_rencana_pekerjaan" required>
                                            <option value="" selected="true">Pilih Bulan</option>
                                            <option value="01">Januari</option>
                                            <option value="02">Februari</option>
                                            <option value="03">Maret</option>
                                ...
                                if($user->kode_jabatan=="007"){
                                   ...
                                   <div class="form-group">
                                    ...
                                    <div class="col-sm-8">
                                        ...
                                        <select onchange="get_ppk()"  id="kode_satuan_kerja" name="kode_satuan_kerja" class="form-control" placeholder="Satuan Kerja"
                                        data-parsley-trigger="change"
                                        required>
                                        ...
                                        $hasil_skpd = $skpd->result();

                                        foreach ($hasil_skpd as $item) {
                                    ...
                                    <input readonly type="text" value="" id="satuan_kerja" name="satuan_kerja" class="form-control" placeholder="Satuan Kerja"
                                    data-parsley-trigger="change"
                                    required>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                    ...
                                    <input readonly type="text" value="<?php echo $user->nama_skpd;?>" id="satuan_kerja" name="satuan_kerja" class="form-control" placeholder="Satuan Kerja"
                                    data-parsley-trigger="change"
                                    required>
                                    <input  type="hidden" value="<?php echo $user->kode_skpd;?>" id="kode_satuan_kerja" name="kode_satuan_kerja" class="form-control" placeholder="Kode Satuan Kerja"
                                    data-parsley-trigger="change"
                                    required>
                                </div> 
                            </div>
...
<script type="text/javascript">
  ...
  function get_ppk(){
    var kode_ppk = $("#kode_satuan_kerja").val();
    $.ajax( {  
        type :"post",  
