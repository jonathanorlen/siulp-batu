    ...
    <img src="<?php echo base_url() . '/public/images/loading1.gif' ?>" style="width:72px; height: 72px;"/>
                                    ...
                                    <form class="form-horizontal" name="data_form" role="form" method="post" id="data_form" id="responsive-usage" data-parsley-validate action="<?php echo base_url().'admin/create_paket/simpan_tambah';?>" id="responsive-usage">
                                       ...
                                       <!-- <div class="form-group">
                                        ...
                                        <div class="col-sm-8"> -->
                                            <input readonly type="hidden" name="kode_paket" value="<?php echo $hasil_data->kode_paket;?>" class="form-control" placeholder="Masukkan Nama Paket">
                                        <!-- </div>
                                    </div> -->
        ...
        <div class="form-group">
            ...
            <div class="col-sm-8">
              ...
              <div style="float:left; margin-left: 10px;"> 
                  <a key="<?php echo $hasil_data->id; ?>" class="tolak btn btn-lightred btn-lg" style="background: red;"><i class="fa fa-arrow-circle-left">&nbsp Revisi</i></a>
              </div> 
              <div style="float:left; margin-left: 10px;"> 
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <textarea placeholder="" style="width: 100%" rows="4" id="keterangan">
...
<div class="modal fade" id="myModal4" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h3 class="modal-title custom-font">Verifikasi Sekretariat</h3>
            </div>
            <div class="modal-body">
                <input type="hidden" id="terima2" />
                        ...
                        <form class="form-horizontal" action="<?php echo base_url(). 'rapat/rapat/simpan_posisi'?>" name="data_form" role="form" method="post" id="data_form" data-parsley-validate action="">
                          ...
                          <div class="form-group">
                            <label class="col-sm-2 control-label">Nama Paket *</label>
                            <div class="col-sm-8">
                              <input readonly type="text" name="paket" id="paket" class="form-control" placeholder="Masukkan Paket"
                              data-parsley-trigger="change" value="<?php echo $hasil_data->nama_paket;?>"
                              required>
                              <input readonly type="hidden" name="kode_paket" id="kode_paket2" class="form-control" placeholder="Masukkan kode_Paket"
                              data-parsley-trigger="change" value="<?php echo $hasil_data->kode_paket;?>"
                              required>
                            </div>
                          </div>
                          ...
                          <div class="form-group">
                            <label class="col-sm-2 control-label">Satuan Kerja *</label>
                            <div class="col-sm-8">
                              <input readonly type="text" name="nama_satuan_kerja" id="nama_satuan_kerja" class="form-control" placeholder="Masukkan Satuan Kerja"
                              data-parsley-trigger="change" value="<?php echo $hasil_data->nama_satuan_kerja;?>"
                              required>
                              <input readonly type="hidden" name="kode_satuan_kerja" id="kode_satuan_kerja" class="form-control" placeholder="Masukkan Satuan Kerja"
                              data-parsley-trigger="change" value="<?php echo $hasil_data->kode_satuan_kerja;?>"
                              required>
                              <?php
                            ...
                            $petugas = $user->uname;
                            ?>
                            <input type="hidden" class="form-control" id="nama_sekretariat" name="nama_sekretariat" value="<?php echo $petugas ?>" />
                        <input type="hidden" class="form-control" id="kode_sekretariat" name="kode_sekretariat" value="<?php echo $id ?>" />
                              <input readonly type="hidden" name="kode_pokja" id="kode_pokja" class="form-control" placeholder="Masukkan Satuan Kerja"
                              data-parsley-trigger="change" value="<?php echo $hasil_data->kode_pokja;?>"
                              required>
                              <input readonly type="hidden" name="nama_pokja" id="nama_pokja" class="form-control" placeholder="Masukkan Satuan Kerja"
                              data-parsley-trigger="change" value="<?php echo $hasil_data->nama_pokja;?>"
                              required>
                              <input readonly type="hidden" name="kode_ppk" id="kode_ppk" class="form-control" placeholder="Masukkan Satuan Kerja"
                              data-parsley-trigger="change" value="<?php echo $hasil_data->kode_ppk;?>"
                              required>
                              <input readonly type="hidden" name="nama_ppk" id="nama_ppk" class="form-control" placeholder="Masukkan Satuan Kerja"
                              data-parsley-trigger="change" value="<?php echo $hasil_data->nama_ppk;?>"
                              required>
                                          ...
                                          <div class="form-group">
                                            ...
                                            <div class="col-sm-8">
                                              <input type="text" readonly="" value="Rapat Kaji Ulang" disable=""  name="agenda" id="agenda" class="form-control" placeholder="Masukkan Agenda"
                                              data-parsley-trigger="change"
                                              required>
                                            </div>
                                          </div>
                                          ...
                                          <div class="form-group">
                                            ...
                                            <div class="col-sm-8">
                                              <input type="text" readonly="" value="ULP" disable=""  name="tempat" id="tempat" class="form-control" placeholder="Masukkan Tempat"
                                              data-parsley-trigger="change" 
                                              required>
                                            </div>
                                          </div>
                                          ...
                                          <div class="form-group">
                                            ...
                                            <div class="col-sm-8">
                                              <input  type="date" value="<?php echo date("Y-m-d")?>" name="tanggal_rapat" id="tanggal_rapat" class="form-control" placeholder="Masukkan Tanggal " required="">
                                            </div>
                                          </div>
                                          ...
                                          <label class="col-sm-2 control-label">Jam Rapat</label>
                                            <div class="col-sm-8">
                                              <input type="text" value="<?php echo date("H:i:s")?>" name="waktu" id="waktu" class="form-control" placeholder="Masukkan Tanggal " required="">
                                            </div>
                                          </div>
            ...
            <div class="modal-footer">
                <a onclick="terima_data2()" class="btn btn-success btn-ef btn-ef-3 btn-ef-3c"><i class="fa fa-arrow-right"></i>Ya</a>
                <a class="btn btn-lightred btn-ef btn-ef-4 btn-ef-4c" data-dismiss="modal"><i class="fa fa-arrow-left"></i> Tidak</a>
            </div>
        </div>
    </div>
...
<div class="modal fade" id="myModalprint" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h3 class="modal-title custom-font">Konfirmasi Cetak</h3>
            </div>
            <div class="modal-body" id="form">
            <div class="form-group">
                    <input type="hidden" id="id_cetak" />
                     <label class=" control-label">Apakah Anda Ingin Mencetak Surat Perintah Tugas</label>
                </div>
            </div>
            <div class="modal-footer">
                <a onclick="cetak_surat()" class="btn btn-success btn-ef btn-ef-3 btn-ef-3c"><i class="fa fa-arrow-right"></i>Ya</a>
                <a onclick="batal_cetak_surat()" class="btn btn-lightred btn-ef btn-ef-4 btn-ef-4c" data-dismiss="modal"><i class="fa fa-arrow-left"></i> Tidak</a>
            </div>
        </div>
    </div>
</div>
...
function cetak_surat(){
    ...
    window.open("<?php echo base_url() . 'admin/create_paket/cetak_surat/' ?>"+id_cetak);
    $("#myModalprint").modal('hide'); 
        $("#myModal4").modal('show'); 
}
function batal_cetak_surat(){
    
        $("#myModal4").modal('show'); 
}
    function terima_data2(){
        var id = $("#terima2").val();
        var kode_paket = $("#kode_paket2").val();
        var kode_rapat = $("#kode_rapat").val();
        var paket = $("#paket").val();
        var nama_satuan_kerja = $("#nama_satuan_kerja").val();
        var kode_satuan_kerja = $("#kode_satuan_kerja").val();
        var nama_pokja = $("#nama_pokja").val();
        var kode_pokja = $("#kode_pokja").val();
        var kode_ppk = $("#kode_ppk").val();
        var nama_ppk = $("#nama_ppk").val();
        var kode_sekretariat = $("#kode_sekretariat").val();
        var nama_sekretariat = $("#nama_sekretariat").val();
        var agenda = $("#agenda").val();
        var tempat = $("#tempat").val();
        var tanggal_rapat = $("#tanggal_rapat").val();
        var waktu = $("#waktu").val();
        var url = "<?php echo base_url().'admin/data_verifikasi/simpan_terima2' ?>";
        $.ajax( {
         type:"POST", 
         url : url,  
         cache :false,  
         data :{id:id,kode_paket:kode_paket,paket:paket,nama_satuan_kerja:nama_satuan_kerja,kode_satuan_kerja:kode_satuan_kerja,agenda:agenda,tempat:tempat,tanggal_rapat:tanggal_rapat,waktu:waktu,nama_pokja:nama_pokja,kode_pokja:kode_pokja,kode_ppk:kode_ppk,nama_ppk:nama_ppk,kode_sekretariat:kode_sekretariat,nama_sekretariat:nama_sekretariat},
         beforeSend:function(){
          $(".tunggu").show();  
      },
      success : function(data) { 
