                            ...
                            <div class="panel panel-default">
                                ...
                                <div id="sidebarNav" class="panel-collapse collapse in" role="tabpanel">
                                    <div class="panel-body">
                                        ...
                                        <ul id="navigation">
                                            <li class=" open">
                                                <a href="<?php echo base_url(). 'admin/dasboard/'?>"><i class="fa fa-delicious"></i> <span>Dashboard</span></a>
                                                <!--<ul>
                                            ...
                                            <li>
                                                ...
                                                <!-- Rapat Kaji Ulang -->
                                                <?php if(in_array('Kaji Ulang',$modul)){ ?>
                                                ...
                                                <?php
                                                    ...
                                                    if($session->kode_jabatan == '003'){
                                                    $kode_pokja = $session->kode_pokja;
                                                ...
                                                <?php
                                                	$jumlah_pokja = $jumlah_rapat + $jumlah_data;
                                                 }
                                                ?>

                                                <?php 
                                                    if($session->kode_jabatan == '002'){;
                                                    	$kode_skpd = $session->kode_skpd;
                                                ?>

                                                <?php 
                                                    $this->db->where('kode_satuan_kerja',$kode_skpd);
                                                    $hasil3=$this->db->get_where('transaksi_data_paket',array('status_paket' => 'Input SPRPP'));
                                                    $hasil_rapat3= $hasil3->result();
                                                    $jumlah_rapat3=count($hasil_rapat3);
                                                ...
                                                <?php 
                                                $this->db->where('kode_satuan_kerja',$kode_skpd);
                                                $hasil2=$this->db->get_where('transaksi_data_paket',array('posisi' => 'Lanjut Lelang'));
                                                $hasil_rapat2= $hasil2->result();
                                                $jumlah_rapat2=count($hasil_rapat2);
                                                ?> 
                                                ...
                                                <?php 
                                                $jumlah_ppk = $jumlah_rapat + $jumlah_rapat2 + $jumlah_rapat3;
                                                	}
                                                ?>
                                                <a href="<?php echo base_url(). 'admin/rapat/';?>" style="
                                                <?php if($session->kode_jabatan == '002'){?><?php if($jumlah_ppk >= 1){?>background-color:#0c7da9<?php }}?>

                                                <?php if($session->kode_jabatan == '003'){?><?php if($jumlah_pokja >= 1){?>background-color:#0c7da9<?php }}?>"><i class="fa fa-pencil">
                                                	
                                                </i> <span> Rapat Kaji Ulang </span>


                                                <?php if($session->kode_jabatan == '001'){?>

                                                    <?php
                                                        $this->db->where('tutup_tahun','Open');
                                                        $this->db->where("(status_pokja='Tolak' OR status_ppk='Tolak')");
                                                        $get = $this->db->get_where("transaksi_rapat",array('notulensi !='=>'terisi'));
                                                        $hasil_get = $get->result();
                                                        $jumlah_get = count($hasil_get);

                                                    if($jumlah_get != 0){
                                                    ?>
                                                    <span  class="badge bg-info" style="left:15px"><?php echo ($jumlah_get);?></span>
                                                <?php } }?>
                                                    ...
                                                    <span  class="badge bg-info"><?php echo (@$jumlah_get);?></span>
                                                            ...
                                                            <li style="width: 80%;" >
                                                                ...
                                                                if($jumlah_rapat3 != '0'){
                                                                    ?>
                                                                    <span class="badge bg-primary"><?php echo ($jumlah_rapat3);?></span>
                                                                ...
                                                                <?php }?>
                                                                    ...
                                                                    if($jumlah_rapat != '0') {
                                                                        ...
                                                                        if($jumlah_rapat != '0'){
                                                                            ...
                                                                            if($jumlah_rapat2 != '0'){
                                                                                ?>
                                                                                <span class="badge bg-lightred"><?php echo ($jumlah_rapat2);?></span>
                                                                                <?php }?>
                                                                                <?php }?>
                                                                                <!-- end -->
                                                                            </a>
                                           ...
                                           <!--  <li class="<?php if(@$menu=="surat_perintah"){ echo "active"; } ?>">
                                            ...
                                            <li class="<?php if(@$menu=="record_lelang"){ echo "active"; } ?>">
                                                ...
                                                <ul>
                                                    ...
                                                    <?php } ?>
                                                    <li><a href="<?php echo base_url() . 'record_lelang/record_paket'?>"><i class="fa fa-caret-right"></i><i class="fa fa-list-alt"></i>Record Paket</a></li>
