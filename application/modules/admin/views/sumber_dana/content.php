                ...
                <div class="page page-hz-menu-layout">
                    ...
                    <section class="tile">
                        ...
                        <div class="tile-header dvd dvd-btm">
                            <h1 class="custom-font">Data&nbsp<strong>Sumber Dana</strong></h1>
                            <ul class="controls">
                                <li class="dropdown">
                                    ...
                                    <tbody>
                                        ...
                                        foreach ($hasil_ambil as $item) {
                                            ...
                                            <tr>
                                               ...
                                               <td>
                                                   <a   href="<?php echo base_url() . 'admin/sumber_dana/detail?id_sumber='.$item->id?>" class="btn btn-success btn-rounded btn-icon-only btn-ef btn-ef-7 btn-ef-7c mb-10" title="Detail"><i class="fa fa-eye" ></i></a>
                                                   <a  href="<?php echo base_url() . 'admin/sumber_dana/ubah?id_sumber='.$item->id?>" class="btn btn-warning btn-rounded btn-icon-only btn-ef btn-ef-7 btn-ef-7c mb-10"  title="Ubah"><i class="fa fa-pencil"></i></a>
...
<script>
    ...
    function hapus_data(){
        var id = $("#hapus").val();
        var url = "<?php echo base_url().'admin/sumber_dana/hapus' ?>";
        $.ajax( {
         type:"POST", 
         url : url,  
         cache :false,  
