                        ...
                        <div class="col-md-12">
                            <section class="tile">
                                ...
                                <div class="tile-header dvd dvd-btm">
                                    <h1 class="custom-font"><strong>Ubah&nbsp</strong>Sumber Dana</h1>
                                </div>
                                <!-- /tile header -->
                                ...
                                <div class="tile-body">
                                    ...
                                    ?>
                                    <form class="form-horizontal" name="data_form" role="form" method="post" data-parsley-validate action="<?php echo base_url().'admin/sumber_dana/simpan_ubah/'?>">

                                        <div class="form-group">
                                            <label class="col-sm-2 control-label">Nama Sumber Dana</label>
                                            <div class="col-sm-8">
                                            <input type="hidden" name="id" class="form-control" value="<?php echo $hasil_ambil_data->id?>" placeholder="ID" required=""/>
                                            <input type="text" name="nama_sumber_dana" class="form-control" value="<?php echo $hasil_ambil_data->nama_sumber_dana?>" placeholder="Masukkan Nip" required=""/>
                                            </div>
                                        </div>
