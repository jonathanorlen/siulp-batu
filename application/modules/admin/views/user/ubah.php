                                      ...
                                      <div class="form-group">
                                        ...
                                        <div class="col-sm-8">
                                            <select class="form-control" name="kode_jabatan" id="jabatan">
                                                ...
                                                <?php
                                                $master_jabatan = $this->db->get_where('master_jabatan',array('nama_jabatan !=' => 'Pihak III','kode_jabatan !='=>'007' ));
                                        ...
                                        <div class="form-group" id="ppk">
                                            ...
                                            <div class="form-group" id="pkj" >
                                                ...
                                                <div class="col-sm-8">
                                                    ...
                                                    <option value="<?php echo $hasil_ambil_data->nama_pokja?>"><?php echo $hasil_ambil_data->nama_pokja?></option> 
                                                        <!-- <option >--PILIH--</option> -->
