...
class setting_user extends MY_Controller {
	...
	{	
		$data['menu'] = 'master';
		$data['konten'] = $this->load->view('forum/setting_user/content', NULL, TRUE);
	...
	{	
		$data['menu'] = 'master';
		$data['konten'] = $this->load->view('forum/setting_user/tambah', NULL, TRUE);
		$this->load->view ('main', $data);	
	}
	public function ubah_data_profile()
	{	
		$data['menu'] = 'master';
		$data['konten'] = $this->load->view('forum/setting_user/ubah_data_profile', NULL, TRUE);
		$this->load->view ('main', $data);
	}
	...
	public function simpan_tambah() {
		...
		$data['group'] = 'Eksternal';

		$this->db->insert("master_user", $data);
	//	echo '<div class="alert alert-success">Sudah tersimpan.</div>';
		header('location:'.base_url().'forum/setting_user/content');             
	}	

	public function daftar()
	{
		$data['menu'] = 'master';
		$data['konten'] = $this->load->view('forum/setting_user/daftar', NULL, TRUE);
		$this->load->view ('main', $data);
	}
	...
	{	
		$data['menu'] = 'master';
		$data['konten'] = $this->load->view('forum/setting_user/detail', NULL, TRUE);
		$this->load->view ('main', $data);
	}
	...
	{	
		$data['menu'] = 'master';
		$data['konten'] = $this->load->view('forum/setting_user/ubah', NULL, TRUE);
		$this->load->view ('main', $data);
	}
