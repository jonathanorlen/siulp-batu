                    ...
                    <div class="pageheader">
                        ...
                        <div class="page-bar">
                            ...
                            <ul class="page-breadcrumb">
                                ...
                                <li>
                                    <a href="<?php echo base_url() . 'forum/setting_user/content'?>">Setup Master</a>
                                </li>
                                <li>
                                    <a>Detail Setting User</a>
                                </li>
                            </ul>
                        ...
                        <div class="col-md-12">
                            <section class="tile">
                                ...
                                <div class="tile-header dvd dvd-btm">
                                    <h1 class="custom-font"><strong>Detail&nbsp</strong>Setup Master</h1>
                                </div>
                                <!-- /tile header -->
                                ...
                                <div class="tile-body">
                                    ...
                                    <form class="form-horizontal" name="data_form" role="form" method="post" id="data_form" data-parsley-validate action="">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-8">
                                                <input disabled="" type="text" name="nama" class="form-control" disabled="" value="<?php echo $hasil_ambil_data->uname?>" placeholder="Masukkan Nama" required="">
                                            </div>
                                        </div>
                                         ...
                                         <div class="form-group">
                                            ...
                                            <div class="col-sm-8">
                                                <input disabled="" type="text" name="nama_jabatan" class="form-control" disabled="" value="<?php echo $hasil_ambil_data->nama_jabatan?>" placeholder="Masukkan Jabatan" required="">
                                            </div>
                                        </div>
                                         <hr class="line-dashed line-full" />
                                         <!-- <div class="form-group">
