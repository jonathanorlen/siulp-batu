<script type="text/javascript">
  $(function () {
    ...
    $("#button").click( function() { 
      ...
      $.ajax( {  
        type :"post",  
        url : "<?php echo base_url() . 'forum/setting_user/simpan_tambah' ?>",  
        cache :false,  
        data :$('#data_form').serialize(),
        success : function(data) {  
          $(".sukses").html(data);   
          setTimeout(function(){$('.sukses').html('');window.location = "<?php echo
            base_url() . 'forum/setting_user/content' ?>";},1000);              
        },  
        error : function() {  
                    ...
                    <div class="pageheader">
                        ...
                        <div class="page-bar">
                            ...
                            <ul class="page-breadcrumb">
                                ...
                                <li>
                                    <a href="<?php echo base_url() . 'forum/setting_user/content'?>">Tambah Setting User</a>
                                </li>
                            </ul>
                                        ...
                                        <!-- <div class="form-group">
                                            ...
                                            <div class="col-sm-8">
                                                <select class="form-control" name="kode_jabatan" id="jabatan">
                                                	<option selected="" value="">--PILIH--</option>
                                                    <?php
                                                        $master_jabatan = $this->db->get('master_jabatan',array('nama_jabatan !=' => 'Pihak III'  ));
                                                        foreach($master_jabatan->result() as $daftar){
