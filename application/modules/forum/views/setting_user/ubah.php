                        ...
                        <div class="col-md-12">
                            <section class="tile">
                                ...
                                <div class="tile-body">
                                    ...
                                    ?>
                                    <form class="form-horizontal" name="data_form" role="form" method="post" id="data_form" data-parsley-validate action="<?php echo base_url().'forum/setting_user/simpan_ubah'?>">
