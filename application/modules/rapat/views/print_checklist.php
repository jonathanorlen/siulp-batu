  ...
  <div style="width:97%;float:right;">
    ...
    <tbody>
      ...
      <tr style="height:30px">
        ...
        <td style="padding-left:5px">Kelengkapan Surat</td>
        <td></td>
        <td></td>
      </tr>
    </tbody>
    ...
    <br>
    <br>
    <div style="font-size:15px;margin-bottom:5px">Kelengkapan dokumen <span style="font-weight:bold">jasa konsultasi</span> yang diterima tanggal</div>
    <table style="width:100%;border-collapse:collapse;" border="1px">
      <tr>
