...
<body onload="window.print()"">
  ...
  <div style="width:97%;float:right;">
    ...
    <br>
    <br>
    <div style="font-size:16px;margin-bottom:5px">Kelengkapan dokumen <span style="font-weight:bold;">pengadaan barang/jasa lainnya </span>yang diterima tanggal </div>
    <table style="width:100%;border-collapse:collapse;" border="1px">
      <tr>
