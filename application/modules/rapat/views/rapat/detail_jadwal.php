                                ...
                                <div class="tile-body">
                                    ...
                                    <form class="form-horizontal" name="data_form" role="form" method="post" id="data_form" data-parsley-validate action="">
                                        ...
                                        <div class="form-group">
                                            <label class="col-sm-2 control-label">Waktu Rapat</label>
                                            <div class="col-sm-8">
                                                <input disabled="" type="text" name="waktu_rapat" class="form-control" disabled="" value="<?php echo $hasil_ambil_data->waktu?>" placeholder="Masukkan waktu Rapat" required="">
                                            </div>
                                        </div>
