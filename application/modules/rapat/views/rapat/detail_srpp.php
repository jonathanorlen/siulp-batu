                        ...
                        <div class="col-md-12">
                            <section class="tile">
                                ...
                                <div class="tile-header dvd dvd-btm">
                                    <h1 class="custom-font"><strong>Detail SPRPP &nbsp</strong><!-- Rapat --></h1>
                                </div>
                                <!-- /tile header -->
                                ...
                                <div class="tile-body" >
                                    ...
                                    <input type="hidden" value="<?php echo $hasil_data->id?>" name="id">
                                        <center>
                                            <u><h3>SURAT PENETAPAN RENCANA PELAKSANAAN PENGADAAN</h3></u>
                                            <h4>Nomor : Sesuai Nomor surat PPK <?php echo $hasil_data->nomor_sprpp?> terkait</h4>
                                        </center>
                                        <br>
                                        <br>
                                        <br>
                                        ...
                                        <label class="col-sm-2">3 . Pengumuman Lelang</label>
                                            <div class="col-sm-4">
                                                <input type="text" readonly name="tanggal_pengumuman_lelang" value="<?php echo TanggalIndo($hasil_data->tanggal_pengumuman_lelang);?>" class="form-control" placeholder="KAK">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                        ...
                                        <label class="col-sm-2">Tanggal Mulai Ambising</label>
                                            <div class="col-sm-3">
                                                <input type="text" readonly name="tanggal_mulai_ambising" value="<?php echo TanggalIndo($hasil_data->tanggal_mulai_ambising);?>" class="form-control" placeholder="tanggal_lelang">
                                            </div>
                                        </div>

                                        <div class="form-group">
                                        <div class="col-sm-1"></div>
                                        <label class="col-sm-2">Waktu Mulai Ambising</label>
                                            <div class="col-sm-3">
                                                <input id="text" readonly type="text"  name="jam_mulai_ambising" value="<?php echo $hasil_data->jam_mulai_ambising;?>" class="form-control" placeholder="Masukkan Waktu Mulai " required="">
                                            </div>
                                        </div>

                                        <div class="form-group">
                                        <div class="col-sm-1"></div>
                                        <label class="col-sm-2">Tanggal Akhir Ambising</label>
                                            <div class="col-sm-3">
                                                <input type="text" readonly name="tanggal_akhir_ambising" value="<?php echo TanggalIndo($hasil_data->tanggal_akhir_ambising);?>" class="form-control" placeholder="tanggal_lelang">
                                            </div>
                                        </div>

                                        <div class="form-group">
                                        <div class="col-sm-1"></div>
                                        <label class="col-sm-2">Waktu Akhir Ambising</label>
                                            <div class="col-sm-3">
                                                <input id="text"  readonly type="text" value="<?php echo $hasil_data->jam_akhir_ambising;?>" name="jam_akhir_ambising" class="form-control" placeholder="Masukkan Waktu Selesai " required="">
                                            </div>
                                        </div>
                                        ...
                                        <label class="col-sm-2">Tanggal Mulai</label>
                                            <div class="col-sm-3">
                                                <input type="date" name="tanggal_mulai_pemasukan" value="<?php echo date('Y-m-d');?>" class="form-control" placeholder="tanggal_lelang" readonly>
                                            </div>
                                        </div>
                                        ...
                                        <label class="col-sm-2">Tanggal Akhir</label>
                                            <div class="col-sm-3">
                                                <input type="date" name="tanggal_selesai_pemasukan" value="<?php echo date('Y-m-d');?>" class="form-control" placeholder="tanggal_lelang" readonly>
                                            </div>
                                        </div>
