                ...
                <div class="page page-hz-menu-layout">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                                ...
                                <div class="tile-body" >
                                    ...
                                    <form id="data_form" class="form-horizontal"  name="data_form" role="form" method="post" data-parsley-validate  >
                                        ...
                                        <div style="font-size:17px">
                                            ...
                                            <input required type="hidden" name="kode_paket" id="id" class="form-control" value="<?php echo $hasil_ambil_data->kode_paket ?>">
                                            <input required type="hidden" name="kode_rapat" id="id" class="form-control" value="<?php echo $hasil_ambil_data->kode_rapat ?>">
                                            <div>
                          ...
                          <div class="form-group">
                            <label class="col-sm-3">SPT Tahunan</label>
                            <div class="col-sm-2">  
...
<div class="form-group">
    <label class="col-sm-8">18 . Masa berlaku penawaran</label>
    <div class="col-sm-2">
     <!--  <input required type="text" class="form-control" name="jadwal_pelaksanaan" id="jadwal_pelaksanaan"> -->
...
<div class="tile-footer text-right bg-tr-white lter dvd dvd-top form-group">
    <div class="form-group">
        ...
        <div class="col-sm-10"">
            <div style="float:left; "> 
              <a key="<?php echo $id; ?>" class=" terima btn-rounded-10 btn btn-primary btn-lg" ><i class="fa fa-save">&nbsp Simpan</i></a>
          </div><!-- 
          <div style="float:left; margin-left: 10px;"> 
...
<div class="modal fade" id="myModal2" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h3 class="modal-title custom-font">Konfirmasi</h3>
            </div>
            <div class="modal-body">
...
function tambah_spesifikasi(){
  ...
  function terima_data(){
    ...
    var url = "<?php echo base_url().'rapat/simpan_notulensi' ?>";
    $.ajax( {
       type:"POST", 
       url : url,  
       cache :false,  
