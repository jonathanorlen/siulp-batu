            ...
            <section id="content">
                ...
                <div class="page page-hz-menu-layout">
                    ...
                    <div class="row">
                      ...
                      <div id="daftar_isi">
                        <div class="form-group">
                            <label class="col-sm-1">&nbsp&nbsp&nbsp a . </label>
                            <div class="col-sm-4">
                               <input type="text" name="personil_inti_minimal[]" id="personil_inti_minimal[]" class="form-control" >
                           </div>
                       </div>
                       <div class="form-group">
                        <label class="col-sm-1">&nbsp&nbsp&nbsp b . </label>
                        <div class="col-sm-4">
                           <input type="text" name="personil_inti_minimal[]" id="personil_inti_minimal[]" class="form-control" >
                       </div>
                   </div>
                   <div class="form-group">
                    <label class="col-sm-1">&nbsp&nbsp&nbsp c . </label>
                    <div class="col-sm-4">
                       <input type="text" name="personil_inti_minimal[]" id="personil_inti_minimal[]" class="form-control" >
                   </div>
               </div>
               <div class="form-group">
                <label class="col-sm-1">&nbsp&nbsp&nbsp d` . </label>
                <div class="col-sm-4">
                   <input type="text" name="personil_inti_minimal[]" id="personil_inti_minimal[]" class="form-control" >
               </div>
           </div>
           <div class="form-group">
            <label class="col-sm-1">&nbsp&nbsp&nbsp e . </label>
            <div class="col-sm-4">
               <input type="text" name="personil_inti_minimal[]" id="personil_inti_minimal[]" class="form-control" >
           </div>
       </div>
   ...
   <div class="form-group">
    ...
    <div class="col-sm-2">
        <select required class="form-control" id="peralatan" name="peralatan_inti" id="peralatan_inti" >
           <option  value="">--PILIH--</option>
           <option value="ada"> Ada</option>
           <option value="tidak ada"> Tidak Ada</option>
       </select>
...
<div class="form-group">
    ...
    <div class="col-sm-2">
      <select class="form-control" id="jenis_kontrak" name="jenis_kontrak" required>
        ...
        <option value="Lompsom">Lompsom</option>
        <option value="Harga satuan">Harga satuan</option>
        <option value="Gabungan lompsom dan harga satuan">Gabungan lompsom dan harga satuan</option>
