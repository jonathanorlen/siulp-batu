...
/*
                                        ...
                                        foreach ($hasil_ambil as $item) {
                                            $no++;
                                            ?>
                                            <tr <?php  if($item->tanggal_rapat ==date('Y-m-d')) { ?> class="danger"   <?php }?>
                                                <?php  if($item->status_pokja == 'Tolak' || $item->status_ppk == 'Tolak') { ?> class="warning"   <?php }?>
                                            ...
                                            <?php $waktu= date("Y-m-d");if($get_group->kode_jabatan == '001'){?>
                                                <?php if($item->tanggal_rapat <= $waktu){?>
                                                <?php  if($item->status_pokja == 'Tolak' || $item->status_ppk == 'Tolak') { ?> 
                                                <a  href="<?php echo base_url(). 'rapat/rapat/ubah_jadwal/'. $item->id;?>" class="btn btn-warning btn-rounded btn-icon-only btn-ef btn-ef-7 btn-ef-7c mb-10" title="Edit"><i class="fa fa-pencil" ></i></a>
                                                <?php } }?>
                                            <?php }?>
                                            </td>
