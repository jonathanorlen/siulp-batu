...
<body onload="window.print()"">
  ...
  <div style="font-size:18.5px">
    ...
    <?php }  ?>
    &nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp Pada Hari Ini <?php echo nama_hari(@$data_rapat->tanggal_notulensi)?> tanggal <?php echo tanggalIndo(@$data_rapat->tanggal_notulensi)?>,bertempat di
...
<?php if(!empty($data_rapat->tempat)){?>
3 . Lokasi pekerjaan <?php echo $data_rapat->tempat?>
<br>
<?php }?>

<?php if(!empty($hasil_data->pagu)){?>
...
<?php if(!empty($hasil_data->nama_sumber_dana)){?>
9 . Sumber Dana (<?php echo $hasil_data->nama_sumber_dana?>)
<br>
<?php }?>
<?php if($hasil_data_id->siup || $hasil_data_id->spt_tahunan != ""){?>

10 . Persyaratan Kualifikasi penyedia
<?php if(empty($hasil_data_id->siup)){?>
<br>
&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbspSIUP <?php echo $hasil_data_id->siup?>
<?php }?>
<?php }?>
<?php if(!empty($hasil_data_id->spt_tahunan)){?>
<br>
&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbspSIUP SPT Tahunan (<?php echo $hasil_data_id->spt_tahunan?>)
<?php }?>

<br>

<?php if(!empty($hasil_data_id->personil_inti_minimal)){?>
...
<?php if($hasil_data_id->personil_inti_minimal != ""){?>
...
<?php if($hasil_data_id->file_jadwal != ""){?>
        ...
        &nbsp&nbsp&nbsp&nbsp&nbsp a . <span style="font-weight:bold"> File Jadwal </span> dan jangka waktu pelaksaan pekerjaan (<?php if($hasil_data_id->file_jadwal == 'ada'){
          ...
          <br>
          &nbsp&nbsp&nbsp&nbsp&nbsp b . <span style="font-weight:bold"> File Daftar Identitas (Jenis,Merk,Type,Lokasi serta Spesfikasi) bahan/material  pabrikasi yang &nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbspdigunakan 
...
<?php if(!empty($hasil_data_id->pembayaran_prestasi)){?>
...
<?php if(!empty($hasil_data->masa_pembayaran)){?>
              18 . Masa berlaku penawaran (<?php echo $hasil_data_id->masa_pembayaran?>) hari
<?php }?>

<?php 
  $data = $hasil_data_id->keterangan_tambahan;
  $explode = explode('|',$data);
if($explode[0] && $explode[1] && $explode[3] != ""){?>
              <?php 
