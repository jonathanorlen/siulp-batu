                ...
                <div class="page page-hz-menu-layout">
                    ...
                    <section class="tile">
                        ...
                        <div class="tile-header dvd dvd-btm">
                            <h1 class="custom-font">Verfikasi Jadwal &nbsp<strong>Rapat</strong></h1>
                            <ul class="controls">
                                <li class="dropdown">
                                    ...
                                    <tbody>
                                        ...
                                        foreach ($hasil_ambil as $item) {
                                            ...
                                            <tr>
                                               ...
                                               <td>
                                                <a  href="<?php echo base_url(). 'rapat/rapat/detail_jadwal_verifikasi?id_jadwal='. $item->id;?>" class="btn btn-success btn-rounded btn-icon-only btn-ef btn-ef-7 btn-ef-7c mb-10" title="Detail"><i class="fa fa-eye" ></i></a>
                                                <a  href="<?php echo base_url(). 'rapat/rapat/verifikasi/'. $item->id;?>" class="btn btn-warning btn-rounded btn-icon-only btn-ef btn-ef-7 btn-ef-7c mb-10" title="Verifikasi"><i class="fa fa-check" ></i></a>
                                            </td>
                                        </tr>
