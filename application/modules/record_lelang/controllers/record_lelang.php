...
class record_lelang extends MY_Controller {
    ...
    public function record_paket()
	{	

		$data['menu'] = 'record_lelang';
		$data['konten'] = $this->load->view('record_lelang/record_lelang/record_paket', NULL, TRUE);
		$this->load->view ('main', $data);
	...
	{	
		...
		$this->load->view('record_lelang/record_lelang/cari_all');
	}
...
//-------------------------------------------------- data paket proses lelang only !!! -------------------------------//
	...
	{	
		...
		$this->load->view('record_lelang/record_lelang/print_all');
