...
<div class="col-md-2">
  ...
  <a target="_blank" style="margin-right: 20px;" id="cetak" class="btn btn-md bg-primary pull-right"><i class="fa fa-print"></i> Print</a>
</div>
</form>
<!-- tile body -->
...
<script>
    ...
    $("#cetak").click(function(){
      ...
      if(nama_paket && jenis_pengadaan==""){
          // alert("n");
          var search = "n";
          window.open("<?php echo base_url(). 'record_lelang/record_lelang/print_sukses/'?>"+search+"/"+nama_paket);
      }else if(jenis_pengadaan && nama_paket==""){
        // alert("j");
        var search = "j";
        window.open("<?php echo base_url(). 'record_lelang/record_lelang/print_sukses/'?>"+search+"/"+jenis_pengadaan);
    }else if(nama_paket && jenis_pengadaan){
        var search = "nj";
        window.open("<?php echo base_url(). 'record_lelang/record_lelang/print_sukses/'?>"+search+"/"+nama_paket+"/"+jenis_pengadaan);
        // alert("nj");
    }else{
        // alert("all");
        var search = "all";
        window.open("<?php echo base_url(). 'record_lelang/record_lelang/print_sukses/'?>"+search);
    }
