 ...
 # $pagu += $item->pagu;
  ...
  <div style="float:left;margin-top:28px;margin-left:55px">
    <center style="font-size:11px;">
      ...
      <br>
      <?php 
      $ulp = $this->db->get_where("master_struktur_ulp",array('jabatan' => 'KEPALA ULP'));
      $ulp_struktur = $ulp->row();
      ?>
      <div style="font-weight:bold"><u><?php echo @$ulp_struktur->nama ;?></u></div>
      <div>
        NIP:<?php echo @$ulp_struktur->nip?>
      </div>
    </center>
  </div>
