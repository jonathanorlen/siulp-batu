...
<?php
                                        ...
                                        $hasil=$this->db->get_where("transaksi_data_paket",array('tutup_tahun'=>'Close','tahun' => $tahun));
...
?>
      <tr>
          <td colspan="7" style="border:1px solid black;text-align:center;font-size:12px">
              JUMLAH
          </td>
      ...
      <tr>
          ...
          <?php 
            $ambil_selesai = $this->db->get_where("transaksi_data_paket",array('tutup_tahun'=>'Close','status_paket'=> 'sukses','tahun' => $tahun));
      ...
      <tr>
          ...
          <?php 
            $ambil_proses = $this->db->query("SELECT * FROM transaksi_data_paket where status_paket != 'gagal' and status_paket != 'sukses' and tutup_tahun = 'Close' and tahun = $tahun ");
      ...
      <tr>
          ...
          <?php 
            $ambil_gagl = $this->db->get_where("transaksi_data_paket",array('tutup_tahun'=>'Close','status_paket'=> 'gagal','tahun' => $tahun));
      ...
      <tr>
          <td colspan="7" style="border:1px solid black;text-align:center;font-size:11px">
