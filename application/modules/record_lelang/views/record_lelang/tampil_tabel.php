            ...
            <section id="content">
                ...
                <div class="page page-hz-menu-layout">
                    ...
                    <div class="pageheader">
                        ...
                        $tahun = $this->db->get_where('transaksi_data_paket',array('tahun'  =>  $parameter));
                        $hasil_tahun = $tahun->row();
                        ?>
                        <h2>Data Paket&nbsp<strong><?php echo $hasil_tahun->tahun?></strong></h2>
                        ...
                        <div class="page-bar">
                            ...
                            <ul class="page-breadcrumb">
                                ...
                                <li>
                                    <a href="<?php echo base_url().'record_lelang/tampil_data_tahun'?>">Data Berdasarkan Tahun </a>
                                </li>
                                <li>
                                    <a>Data Paket</a>
                                </li>
                    ...
                    <section class="tile">
                        ...
                        <div class="tile-header dvd dvd-btm">
                            <h1 class="custom-font">Data&nbsp<strong>Paket</strong>&nbsp<span><?php echo $hasil_tahun->tahun?></span></h1>
                            <ul class="controls">
                                <li class="dropdown">
                        ...
                        <div class="tile-body">
                            <form class="form-inline" role="form">
                                ...
                                $user =  $this->session->userdata('astrosession');
                                    ...
                                    ?>
                                    <a target="_blank" style="margin-left: 20px;" href="<?php echo base_url(). 'record_lelang/record_lelang/print_tahunan/'.$tahun?>" class="btn btn-md bg-primary"><i class="fa fa-print"></i> Print</a>
                                </div>
                            </form>
                           <!--  <div class="">
                                <?php
                                    ...
                                    <div id="cari_status">
                                        <table style="font-size: small;" class="table table-hover table-custom dt-responsive" id="responsive-usage">
                                            ...
                                            <tbody>
                                                ...
                                                <a href="<?php echo base_url().'record_lelang/record_lelang/detail_tahun/'.$item->id;?>" title="Detail" class="btn btn-success btn-rounded btn-icon-only btn-ef btn-ef-7 btn-ef-7c mb-10" style="position:relative;padding:10px 15px"><i class="fa fa-eye"  style="font-size:15px;position:relative;line-height:10px"></i></a>
        ...
        <script>
            ...
            function get_status(){
                ...
                var url = "<?php echo base_url().'record_lelang/record_lelang/cari_tahun' ?>";
                $.ajax( {
                 type:"POST", 
                 url : url,  
                 cache :false,  
