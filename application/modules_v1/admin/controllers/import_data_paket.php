...
for ($i=2; $i<=$hasildata; $i++)
{
	...
	$query = "INSERT INTO master_data_paket VALUES (null,'$nama_paket','','$kegiatan','$volume','$lokasi','$pagu','$kode_satuan_kerja','$nama_satuan_kerja','$nama_sumber_dana','$jenis_pengadaan','$tanggal_rencana_pengadaan','$tanggal_rencana_pekerjaan')";
