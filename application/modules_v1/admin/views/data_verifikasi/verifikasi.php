                    ...
                    <div class="pageheader">
                        ...
                        <div class="page-bar">
                            ...
                            <ul class="page-breadcrumb">
                                <li>
                                    <a><i class="fa fa-home">&nbsp</i>Data Paket Lelang</a>
                                </li>
                                <li>
    ...
    <img src="<?php echo base_url() . '/public/images/loading1.gif' ?>" style="width:72px; height: 72px;"/>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-8">
                                            <input readonly type="text" name="tanggal_pengajuan" value="<?php echo BUlanIndo($hasil_data->tanggal_pengajuan) ;?>" class="form-control" placeholder="Masukkan Tanggal Pengajuan"
