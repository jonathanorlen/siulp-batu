                                    ...
                                    <div class="panel-body">
                                        ...
                                        <ul id="navigation">
                                            ...
                                            <li>
                                                ...
                                                $tgl = date("Y-m-d");
                                                $jadwal_rapat = $this->db->get_where('transaksi_rapat',array('tanggal_rapat ='=>  $tgl,'tutup_tahun'=>'Open'));
                                                $hasil_jadwal = $jadwal_rapat->result();
                                                $jumlah_jadwal = count($hasil_jadwal);

                                                ?>

                                                <a href="<?php echo base_url(). 'admin/rapat/';?>"><i class="fa fa-pencil"></i> <span> Rapat Kaji Ulang </span><?php if(!empty($jumlah_jadwal)){ ;?><span  class="badge bg-danger"><?php echo ($jumlah_jadwal);?></span><?php } ?> </a>
                                                <ul>

                                                    <?php if(in_array('Input Rapat',$modul)){ ?>
                                                    <li><a href="<?php echo base_url() . 'rapat/rapat/content/'?>"><i class="fa fa-caret-right"></i><i class="fa fa-plus-square"></i> Input Rapat <?php if(!empty($jumlah_input)){ ;?><span  class="badge bg-danger"><?php echo ($jumlah_input);?></span><?php } ?></a></li>
                                                    <?php } ?>

                                                    <?php if(in_array('Jadwal Rapat',$modul)){ ?>
                                                    <li><a href="<?php echo base_url() . 'rapat/rapat/jadwal_rapat/'?>"><i class="fa fa-caret-right"></i><i class="fa fa-calendar"></i>Data Jadwal Rapat <?php if(!empty($jumlah_jadwal)){ ;?><span  class="badge bg-danger"><?php echo ($jumlah_jadwal);?></span><?php } ?><!--  <?php if(!empty($hasil_count)){ ;?><span  class="badge bg-info"><?php echo count($hasil_count);?></span><?php } ?> --></a></li>
                                                    <?php } ?>

                                                    <?php if(in_array('Hasil Rapat',$modul)){ ?>
                                                    <li><a href="<?php echo base_url() . 'rapat/rapat/hasil_rapat/'?>"><i class="fa fa-caret-right"></i><i class="fa fa-calendar"></i>Hasil Rapat </a></li>
                                                    <?php } ?>
                                           ...
                                           <!--  <li class="<?php if(@$menu=="surat_perintah"){ echo "active"; } ?>">
                                            ...
                                            <li class="<?php if(@$menu=="record_lelang"){ echo "active"; } ?>">
                                                ...
                                                <ul>
                                                    <!--<li><a href="<?php echo base_url() . 'record_lelang/data_proses_lelang'?>"><i class="fa fa-caret-right"></i><i class="fa fa-exclamation"></i> Data Paket Proses Lelang</a></li>-->
