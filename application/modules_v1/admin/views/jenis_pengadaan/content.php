                ...
                <div class="page page-hz-menu-layout">
                    ...
                    <section class="tile">
                        ...
                        <div class="tile-header dvd dvd-btm">
                            <h1 class="custom-font">Data&nbsp<strong>Jenis Pengadaan</strong></h1>
                            <ul class="controls">
                                <li class="dropdown">
                        ...
                        ?>
                                   ...
                                   <td><?php echo $no;?></td>
                                    ...
                                    <td>
                                        <a href="<?php echo base_url() . 'admin/jenis_pengadaan/detail?id_jenis='.$item->id?>">
                                        <button class="btn btn-success btn-rounded btn-ef btn-ef-5 btn-ef-5b mb-10"><span>Detail</span><i class="fa fa-eye"></i></button></a>
                                        <a href="<?php echo base_url() . 'admin/jenis_pengadaan/ubah?id_jenis='.$item->id?>">
...
<div class="modal fade" id="myModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
        ...
        function hapus_data(){
            var id = $("#hapus").val();
            var url = "<?php echo base_url().'admin/jenis_pengadaan/hapus' ?>";
             $.ajax( {
                 type:"POST", 
                 url : url,  
                 cache :false,  
