                                ...
                                <div class="tile-body">
                                    ...
                                    <form class="form-horizontal" name="data_form" role="form" method="post" id="data_form" data-parsley-validate action="">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-8">
                                                <input disabled="" type="text" name="nama" class="form-control" disabled="" value="<?php echo $hasil_ambil_data->nama?>" placeholder="Masukkan Nip" required="">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-8">
                                                <input disabled="" type="text" name="tlp" class="form-control" placeholder="Jabatan"
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-8">
                                                <input disabled="" type="text" name="alamat" class="form-control" placeholder="Masukkan Pangkat"
