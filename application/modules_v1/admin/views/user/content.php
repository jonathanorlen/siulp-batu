                ...
                <div class="page page-hz-menu-layout">
                    ...
                    <section class="tile">
                        ...
                        <div class="tile-header dvd dvd-btm">
                            <h1 class="custom-font">Data&nbsp<strong>User</strong></h1>
                            <ul class="controls">
                                <li class="dropdown">
                        ...
                        <div class="tile-body">
                            ...
                            <div class="table-responsive">
                                ...
                                <table class="table table-hover table-custom dt-responsive" id="responsive-usage">
                                    ...
                                    <tbody>
                                        <?php
                                        $hasil=$this->db->get_where("master_user",array('group !='=>'root'));
                                        ...
                                        foreach ($hasil_ambil as $item) {
                                            ...
                                            <tr>
                                             ...
                                             <td><?php echo @$item->pangkat_gol;?></td> 
                                             <?php if (@$item->kode_jabatan != '002'){ ?>
                                             ...
                                             <?php } ?>
                                             <td>
                                               <a  href="<?php echo base_url(). 'admin/user/detail?id='. $item->id;?>" title="Detail" class="btn btn-success btn-rounded btn-icon-only btn-ef btn-ef-7 btn-ef-7c mb-10" ><i class="fa fa-eye" ></i></a>
                                               <a  href="<?php echo base_url(). 'admin/user/ubah?id='. $item->id;?>" title="Ubah" class="btn btn-warning btn-rounded-1 btn-icon-only btn-ef btn-ef-5 btn-ef-7c mb-10"><i class="fa fa-pencil" ></i></a>
    ...
    <script>
        ...
        function hapus_data(){
            var id = $("#hapus").val();
            var url = "<?php echo base_url().'admin/user/hapus' ?>";
            $.ajax( {
               type:"POST", 
               url : url,  
               cache :false,  
