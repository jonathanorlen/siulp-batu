                                    ...
                                    <tbody>
                                        ...
                                        foreach ($hasil_ambil as $item) {
                                            ...
                                            <tr>
                                             ...
                                             <td>
                                                <a href="<?php echo base_url().'rapat/rapat/detail_jadwal?id_jadwal='.$item->id;?>"><button class="btn btn-success btn-rounded btn-ef btn-ef-5 btn-ef-5b mb-10"><span>Detail</span><i class="fa fa-eye"></i></button></a>
                                            </td>
                                        </tr>
