                    ...
                    <div class="pageheader">
                        ...
                        <div class="page-bar">
                            ...
                            <ul class="page-breadcrumb">
                                ...
                                <li>
                                    <a href="<?php echo base_url() . 'honor_pokja/data_honor_pokja/content'?>">Data Honor</a>
                                </li>
                            </ul>
                            ...
                            <div class="table-responsive">
                                <div id="cari_status">
                                    ...
                                    <tbody>
                                        ...
                                        $hasil=$this->db->get_where("transaksi_data_paket",array('tutup_tahun'=>'Open','status_paket'=>'Sukses','pencairan_gaji'=>''));
    ...
    <script>
        ...
        function get_status(){
            ...
            var url = "<?php echo base_url().'honor_pokja/data_honor_pokja/get_data_honor' ?>";
            $.ajax( {
               type:"POST", 
               url : url,  
               cache :false,  
