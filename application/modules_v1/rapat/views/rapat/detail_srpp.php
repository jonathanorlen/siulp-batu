                        ...
                        <div class="col-md-12">
                            <section class="tile">
                                ...
                                <div class="tile-header dvd dvd-btm">
                                    <h1 class="custom-font"><strong>Detail Form SPRPP &nbsp</strong><!-- Rapat --></h1>
                                </div>
                                <!-- /tile header -->
                                ...
                                <div class="tile-body" >
                                    ...
                                    <input type="hidden" value="<?php echo $hasil_data->id?>" name="id">
                                        ...
                                        <label class="col-sm-2">3 . Tanggal Pengumuan lelang</label>
                                            <div class="col-sm-4">
                                                <!-- <input type="text" disable readonly="" value="<?php echo TanggalIndo($hasil_data->spesifikasi_kak);?>" name="spesifikasi_kak" class="form-control" placeholder="KAK"> -->
                                                <span>:</span>&nbsp<label><?php echo TanggalIndo($hasil_data->spesifikasi_kak);?></label>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                        <label class="col-sm-2">4 . Tanggal Lelang</label>
                                            <div class="col-sm-4">
                                                <!-- <input type="text" disable readonly name="tanggal_lelang" value="<?php echo TanggalIndo($hasil_data->tanggal_lelang);?>" class="form-control" placeholder="tanggal_lelang"> -->
                                                <span>:</span>&nbsp<label><?php echo TanggalIndo($hasil_data->tanggal_lelang);?></label>
                                            </div>
                                        </div>
