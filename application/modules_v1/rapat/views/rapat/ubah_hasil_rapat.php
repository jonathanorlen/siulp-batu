        ...
        <section class="tile">
          ...
          <div class="tile-body">
            ...
            <form class="form-horizontal" name="data_form" role="form" method="post" id="form_tanggal_pengajuan" enctype="multipart/form-data" data-parsley-validate>
              ...
              <a title="Edit" id="edit_tanggal_pengajuan" class="btn btn-md btn-warning"><i class="fa fa-edit"></i> Edit Bulan Pengajuan</a>
...
<form class="form-horizontal" name="data_form" role="form" action="<?php echo base_url().'rapat/rapat/simpan_ubah_hasil';?>" method="post" id="data_form" enctype="multipart/form-data" data-parsley-validate>
  <input type="hidden" name="kode_paket" value="<?php echo $hasil_data->kode_paket;?>" class="form-control" placeholder="Masukkan Nama Paket" required="">
  <div class="form-group">
