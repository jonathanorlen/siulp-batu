 ...
 -->
                                <table style="font-size: small;" class="table table-hover table-custom dt-responsive" id="tabel_gagal">
                                    <thead>
                                        <tr class="info">
                                            <th>No</th>
...
/*                                        $key=$data['key'];/**/
                                    ...
                                    $get_product =$this->db->get_where("transaksi_data_paket",array('status_paket' => 'gagal','tutup_tahun'=>'Open'));
