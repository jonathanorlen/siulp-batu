                ...
                <div class="pageheader">
                  ...
                  <div class="page-bar">
                    ...
                    <ul class="page-breadcrumb">
                      <li>
                        <a><i class="fa fa-home">&nbsp</i>Record</a>
                      </li>
                      <li>
                    ...
                    <section class="tile" >
                      ...
                      <div class="tile-body">
                        ...
                        <form class="form-horizontal" name="data_form" role="form" method="post" id="data_form" data-parsley-validate action="<?php echo base_url().'admin/create_paket/simpan_tambah';?>" id="responsive-usage" style="">
                          ...
                          <a href="<?php echo base_url().'record_lelang/record_lelang/tampil_data_tahun/'?>" style="margin-left: 10px;" class="btn btn-info btn-ef btn-ef-3 btn-ef-3c mb-10" title="Data Tahunan"><H1>Data Tahun</H1></a>
                          <a key="<?php echo date('Y')?>" style="" class=" terima btn btn-danger btn-ef btn-ef-3 btn-ef-3c mb-10" title="Tutup Tahun"><h1>Tutup Tahun</h1></a>
          ...
          <div class="modal-dialog">
            <div class="modal-content">
              ...
              <div class="modal-body">
                ...
                Apakah anda yakin ingin menutup data tahun <?php echo date("Y");?> tersebut ?
              </div>
              <div class="modal-footer">
