                                    ...
                                    <tbody>
                                        ...
                                        foreach ($hasil_ambil as $item) {
                                            ...
                                            <tr>
                                             ...
                                             <td>
                                                <a href="<?php echo base_url().'rapat/rapat/detail_jadwal?id_jadwal='.$item->id;?>"><button class="btn btn-success btn-rounded btn-ef btn-ef-5 btn-ef-5b mb-10"><span>Detail</span><i class="fa fa-eye" title="Detail"></i></button></a>
                                                <a target="_blank" id="cetak_rapat"><button class="btn btn-primary btn-rounded btn-ef btn-ef-5 btn-ef-5b mb-10"><span>Cetak</span><i class="fa fa-print" title="Cetak"></i></button></a>
                                            </td>
                                        </tr>
