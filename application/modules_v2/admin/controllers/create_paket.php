...
class create_paket extends MY_Controller {
    ...
    public function generate_pdf(){
       ...
       //generate the PDF from the given html
        ...
        //echo FILE_PATH ."arif.pdf";
        $pdfFilePath = FILE_PATH ."surat_perintah_tugas.pdf";
    ...
    $config = Array(
      ...
      'wordwrap' => TRUE
          ...
          $this->email->to("yukotanjung@gmail.com");
          $this->email->subject('Surat Perintah Kerja');
          $this->email->message("isi terlampir");
           define('FILE_PATH' , $_SERVER['DOCUMENT_ROOT']."/component/upload/file/uploads/");
           $link = FILE_PATH."dokumen_dpa_170403143830.pdf";
