...
class surat_perintah_tugas extends MY_Controller {
	...
	{
		$data['konten'] = $this->load->view('surat_perintah_tugas/content', NULL, TRUE);
		$this->load->view ('main', $data);
	}
	public function tambah()
	{
		$data['konten'] = $this->load->view('surat_perintah_tugas/tambah', NULL, TRUE);
		$this->load->view ('main', $data);
	}
