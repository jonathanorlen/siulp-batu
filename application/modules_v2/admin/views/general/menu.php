                                                ...
                                                <ul>
                                                 ...
                                                 <span style="margin-left: 15px;margin-right: 15px;" class="badge bg-success"><?php echo ($jumlah_jadwal2);?></span>
                                                    ...
                                                    <?php 
                                                        if($jumlah_rapat != '0') {
                                                    ?>
                                                        <span class="badge bg-danger"><?php echo ($jumlah_rapat);?></span>
                                           ...
                                           <!--  <li class="<?php if(@$menu=="surat_perintah"){ echo "active"; } ?>">
                                            ...
                                            <li class="<?php if(@$menu=="record_lelang"){ echo "active"; } ?>">
                                                ...
                                                <ul>
                                                    ...
                                                    <li><a href="<?php echo base_url() . 'record_lelang/hasil_lelang'?>"><i class="fa fa-caret-right"></i><i class="fa fa-exclamation"></i> Input Hasil Lelang</a></li>
                                                    <?php } ?>
