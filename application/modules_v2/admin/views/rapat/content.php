            ...
            <section id="content">
                ...
                <div class="page page-hz-menu-layout">
                    ...
                    <div class="pageheader">
                        ...
                        <div class="page-bar">
                            ...
                            <ul class="page-breadcrumb">
                                ...
                                <li>
                                    <a href="<?php echo base_url() . 'admin/kelompok_kerja/content'?>">Rapat</a>
                                </li>
                            </ul>
                    ...
                    <section class="tile">
                        ...
                        <div class="tile-body">
                        <div class="">
                        <a href="<?php echo base_url() . 'admin/rapat/tambah'?>"><button class="btn btn-md btn-rounded btn-ef btn-ef-2 btn-ef-2-primary btn-ef-2a mb-10"><i class="fa fa-plus"></i> Tambah</button></a>
                        <a href="<?php echo base_url() . 'admin/rapat/content'?>"><button class="btn btn-md btn-rounded btn-ef btn-ef-2 btn-ef-2-success btn-ef-2a mb-10"><i class="fa fa-list"></i> Daftar</button></a>
                        ...
                        ?>
                                   ...
                                   <td><?php echo $no;?></td>
                                    ...
                                    <td><?php echo $item->pangkat;?></td>
                                    <td>
                                        <a href="<?php echo base_url().'admin/kelompok_kerja/detail?id_kelompok='.$item->id;?>"><button class="btn btn-success btn-rounded btn-ef btn-ef-5 btn-ef-5b mb-10"><span>Detail</span><i class="fa fa-eye"></i></button></a>
                                        <a href="<?php echo base_url().'admin/kelompok_kerja/ubah?id_kelompok='.$item->id?>"><button class="btn btn-warning btn-rounded btn-ef btn-ef-5 btn-ef-5b mb-10"><span>Edit</span><i class="fa fa-pencil"></i></button></a>
...
<div class="modal fade" id="myModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
        ...
        function hapus_data(){
            var id = $("#hapus").val();
            var url = "<?php echo base_url().'admin/kelompok_kerja/hapus' ?>";
             $.ajax( {
                 type:"POST", 
                 url : url,  
                 cache :false,  
