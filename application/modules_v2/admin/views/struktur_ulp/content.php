            							...
            							foreach ($hasil_ambil as $item) {
            								...
            								<tr>
            									...
            									<td>
            										...
            										<a  href="<?php echo base_url(). 'admin/struktur_ulp/detail/'. $item->id;?>" class="btn btn-success btn-rounded btn-icon-only btn-ef btn-ef-7 btn-ef-7c mb-10" title="Detail"><i class="fa fa-eye" ></i></a>
            										<a  href="<?php echo base_url(). 'admin/struktur_ulp/ubah?id='. $item->id;?>" class="btn btn-warning btn-rounded btn-icon-only btn-ef btn-ef-7 btn-ef-7c mb-10" title="Ubah"><i class="fa fa-pencil" ></i></a>
