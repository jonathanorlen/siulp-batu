        ...
        <div id="wrap" class="animsition">
            ...
            <section id="header">
                <header class="clearfix">
                    ...
                    <!-- Branding -->
                    <div class="branding">
                        <a class="brand" href="<?php echo base_url() . 'component/admin/index.html'?>">
                    ...
                    <ul class="nav-right pull-right list-inline">
                        ...
                        <li class="dropdown nav-profile">
                            ...
                            <a href class="dropdown-toggle" data-toggle="dropdown">
                                <img src="<?php echo base_url(). 'component/admin/assets/images/profile-photo.jpg'?>" alt="" class="img-circle size-30x30">
                            ...
                            <div class="panel panel-default">
                                ...
                                <div id="sidebarNav" class="panel-collapse collapse in" role="tabpanel">
                                    <div class="panel-body">
                                        ...
                                        ==================================================== -->
                                        <ul id="navigation">
                                            <li><a href="<?php echo base_url() . 'component/admin/index.html'?>"><i class="fa fa-dashboard"></i> <span>Dashboard</span></a></li>
                                            <li>
                                                <a href="#"><i class="fa fa-envelope-o"></i> <span>Mail</span> <span class="badge bg-lightred">6</span></a>
                                                <ul>
                                                    <li><a href="<?php echo base_url() . 'component/admin/mail-inbox.html'?>"><i class="fa fa-caret-right"></i> Inbox</a></li>
                                                    <li><a href="<?php echo base_url() . 'component/admin/mail-compose.html'?>"><i class="fa fa-caret-right"></i> Compose Mail</a></li>
                                                    <li><a href="<?php echo base_url() . 'component/admin/mail-single.html'?>"><i class="fa fa-caret-right"></i> Single Mail</a></li>
                                                </ul>
                                            </li>
                                            <li>
                                                <a href="#"><i class="fa fa-list"></i> <span>Form Stuff</span></a>
                                                <ul>
                                                    <li><a href="<?php echo base_url() . 'component/admin/form-common.html'?>"><i class="fa fa-caret-right"></i> Common Elements</a></li>
                                                    <li><a href="<?php echo base_url() . 'component/admin/form-validate.html'?>"><i class="fa fa-caret-right"></i> Validation Elements</a></li>
                                                    <li><a href="<?php echo base_url() . 'component/admin/form-wizard.html'?>"><i class="fa fa-caret-right"></i> Form Wizard <span class="badge badge-success">13</span></a></li>
                                                    <li><a href="<?php echo base_url() . 'component/admin/form-upload.html'?>"><i class="fa fa-caret-right"></i> File Upload</a></li>
                                                    <li><a href="<?php echo base_url() . 'component/admin/form-imgcrop.html'?>"><i class="fa fa-caret-right"></i> Image Crop</a></li>
                                                </ul>
                                            </li>
                                            <li>
                                                <a href="#"><i class="fa fa-pencil"></i> <span>UI Kit</span></a>
                                                <ul>
                                                    <li><a href="<?php echo base_url() . 'component/admin/ui-general.html'?>"><i class="fa fa-caret-right"></i> General Elements</a></li>
                                                    <li><a href="<?php echo base_url() . 'component/admin/ui-buttons-icons.html'?>"><i class="fa fa-caret-right"></i> Buttons & Icons</a></li>
                                                    <li><a href="<?php echo base_url() . 'component/admin/ui-typography.html'?>"><i class="fa fa-caret-right"></i> Typography</a></li>
                                                    <li><a href="<?php echo base_url() . 'component/admin/ui-navs.html'?>"><i class="fa fa-caret-right"></i> Navigation & Accordions</a></li>
                                                    <li><a href="<?php echo base_url() . 'component/admin/ui-modals.html'?>"><i class="fa fa-caret-right"></i> Modals</a></li>
                                                    <li><a href="<?php echo base_url() . 'component/admin/ui-tiles.html'?>"><i class="fa fa-caret-right"></i> Tiles</a></li>
                                                    <li><a href="<?php echo base_url() . 'component/admin/ui-portlets.html'?>"><i class="fa fa-caret-right"></i> Portlets</a></li>
                                                    <li><a href="<?php echo base_url() . 'component/admin/ui-grid.html'?>"><i class="fa fa-caret-right"></i> Grid</a></li>
                                                    <li><a href="<?php echo base_url() . 'component/admin/ui-widgets.html'?>"><i class="fa fa-caret-right"></i> Widgets</a></li>
                                                    <li><a href="<?php echo base_url() . 'component/admin/ui-tree.html'?>"><i class="fa fa-caret-right"></i> Tree </a></li>
                                                    <li><a href="<?php echo base_url() . 'component/admin/ui-lists.html'?>"><i class="fa fa-caret-right"></i> Lists</a></li>
                                                    <li><a href="<?php echo base_url() . 'component/admin/ui-alerts.html'?>"><i class="fa fa-caret-right"></i> Alerts & Notifications</a></li>
                                                </ul>
                                            </li>
                                            <li>
                                                <a href="#"><i class="fa fa-shopping-cart"></i> <span>Shop</span> <span class="label label-success">new</span></a>
                                                <ul>
                                                    <li><a href="<?php echo base_url() . 'component/admin/shop-orders.html'?>"><i class="fa fa-caret-right"></i> Orders</a></li>
                                                    <li><a href="<?php echo base_url() . 'component/admin/shop-single-order.html'?>"><i class="fa fa-caret-right"></i> Single Order</a></li>
                                                    <li><a href="<?php echo base_url() . 'component/admin/shop-products.html'?>"><i class="fa fa-caret-right"></i> Products</a></li>
                                                    <li><a href="<?php echo base_url() . 'component/admin/shop-single-product.html'?>"><i class="fa fa-caret-right"></i> Single Product</a></li>
                                                    <li><a href="<?php echo base_url() . 'component/admin/shop-invoices.html'?>"><i class="fa fa-caret-right"></i> Invoices</a></li>
                                                    <li><a href="<?php echo base_url() . 'component/admin/shop-single-invoice.html'?>"><i class="fa fa-caret-right"></i> Single Invoice</a></li>
                                                </ul>
                                            </li>
                                            <li>
                                                <a role="button" tabindex="0"><i class="fa fa-table"></i> <span>Tables</span></a>
                                                <ul>
                                                    <li><a href="<?php echo base_url() . 'component/admin/tables-bootstrap.html'?>"><i class="fa fa-caret-right"></i> Bootstrap Tables</a></li>
                                                    <li><a href="<?php echo base_url() . 'component/admin/tables-datatables.html'?>"><i class="fa fa-caret-right"></i> DataTables</a></li>
                                                    <li><a href="<?php echo base_url() . 'component/admin/tables-footable.html'?>"><i class="fa fa-caret-right"></i> FooTable</a></li>
                                                </ul>
                                            </li>
                                            <li>
                                                <a href="#"><i class="fa fa-desktop"></i> <span>Extra Pages</span></a>
                                                <ul>
                                                    <li><a href="<?php echo base_url() . 'component/admin/login.html'?>"><i class="fa fa-caret-right"></i> Login Page</a></li>
                                                    <li><a href="<?php echo base_url() . 'component/admin/signup.html'?>"><i class="fa fa-caret-right"></i> Signup Page</a></li>
                                                    <li><a href="<?php echo base_url() . 'component/admin/forgotpass.html'?>"><i class="fa fa-caret-right"></i> Forgot Password Page</a></li>
                                                    <li><a href="<?php echo base_url() . 'component/admin/page404.html'?>"><i class="fa fa-caret-right"></i> Page 404</a></li>
                                                    <li><a href="<?php echo base_url() . 'component/admin/page500.html'?>"><i class="fa fa-caret-right"></i> Page 500</a></li>
                                                    <li><a href="<?php echo base_url() . 'component/admin/page-offline.html'?>"><i class="fa fa-caret-right"></i> Page Offline</a></li>
                                                    <li><a href="<?php echo base_url() . 'component/admin/locked.html'?>"><i class="fa fa-caret-right"></i> Locked Screen</a></li>
                                                    <li><a href="<?php echo base_url() . 'component/admin/gallery.html'?>"><i class="fa fa-caret-right"></i> Gallery</a></li>
                                                    <li><a href="<?php echo base_url() . 'component/admin/timeline.html'?>"><i class="fa fa-caret-right"></i> Timeline</a></li>
                                                    <li><a href="<?php echo base_url() . 'component/admin/chat.html'?>"><i class="fa fa-caret-right"></i> Chat</a></li>
                                                    <li><a href="<?php echo base_url() . 'component/admin/search-results.html'?>"><i class="fa fa-caret-right"></i> Search Results</a></li>
                                                    <li><a href="<?php echo base_url() . 'component/admin/profile.html'?>"><i class="fa fa-caret-right"></i> Profile Page</a></li>
                                                </ul>
                                            </li>
                                            <li class="active open">
                                                <a href="#"><i class="fa fa-delicious"></i> <span>Layouts</span></a>
                                                <ul>
                                                    <li><a href="<?php echo base_url() . 'component/admin/layout-boxed.html'?>"><i class="fa fa-caret-right"></i> Boxed layout</a></li>
                                                    <li><a href="<?php echo base_url() . 'component/admin/layout-fullwidth.html'?>"><i class="fa fa-caret-right"></i> Full-width layout</a></li>
                                                    <li><a href="<?php echo base_url() . 'component/admin/layout-sidebar-sm.html'?>"><i class="fa fa-caret-right"></i> Small sidebar</a></li>
                                                    <li><a href="<?php echo base_url() . 'component/admin/layout-sidebar-xs.html'?>"><i class="fa fa-caret-right"></i> Extra-small sidebar</a></li>
                                                    <li><a href="<?php echo base_url() . 'component/admin/layout-offcanvas.html'?>"><i class="fa fa-caret-right"></i> Off-canvas sidebar  <span class="label label-success">new</span></a></li>
                                                    <li class="active"><a href="<?php echo base_url() . 'component/admin/layout-hz-menu.html'?>"><i class="fa fa-caret-right"></i> Horizontal menu</a></li>
                                                    <li><a href="<?php echo base_url() . 'component/admin/layout-rtl.html'?>"><i class="fa fa-caret-right"></i> RTL layout</a></li>
                                                </ul>
                                            </li>
                                            <li>
                                            ...
                                            <li>
                                                ...
                                                <ul>
                                                    <li><a href="<?php echo base_url() . 'component/admin/maps-vector.html'?>"><i class="fa fa-caret-right"></i> Vector Maps</a></li>
                                                    <li><a href="<?php echo base_url() . 'component/admin/maps-google.html'?>"><i class="fa fa-caret-right"></i> Google Maps</a></li>
                                                </ul>
                                            </li>
                                            <li><a href="<?php echo base_url() . 'component/admin/calendar.html'?>"><i class="fa fa-calendar-o"></i> <span>Calendar</span> <span class="label label-success">new events</span></a></li>
                                            <li><a href="<?php echo base_url() . 'component/admin/charts.html'?>"><i class="fa fa-bar-chart-o"></i> <span>Charts & Graphs</span></a></li>
            ...
            <section id="content">
                ...
                <div class="page page-hz-menu-layout">
                    ...
                    <div class="pageheader">
                        ...
                        <h2>Horizontal menu Layout <span>// You can place subtitle here</span></h2>

                        <div class="page-bar">

                            <ul class="page-breadcrumb">
                                <li>
                                    <a href="<?php echo base_url() . 'component/admin/index.html'?>"><i class="fa fa-home"></i> Minovate</a>
                                </li>
                                <li>
                                    <a href="#">Layouts</a>
                                </li>
                                <li>
                                    <a href="<?php echo base_url() . 'component/admin/layout-hz-menu.html'?>">Horizontal menu Layout</a>
                                </li>
                            </ul>
