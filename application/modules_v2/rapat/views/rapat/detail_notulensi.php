...
<?php 
    ...
    <div class="form-group">
        <label class="col-sm-1">&nbsp&nbsp&nbsp a . </label>
        <div class="col-sm-4">
           <?php echo @$hasil_explode[0];?>
       </div>
   </div>
   <div class="form-group">
    <label class="col-sm-1">&nbsp&nbsp&nbsp b . </label>
    <div class="col-sm-4">
       <?php echo @$hasil_explode[1];?>
   </div>
</div>
<div class="form-group">
    <label class="col-sm-1">&nbsp&nbsp&nbsp c . </label>
    <div class="col-sm-4">
       <?php echo @$hasil_explode[2];?>
   </div>
</div>
<div class="form-group">
    <label class="col-sm-1">&nbsp&nbsp&nbsp d . </label>
    <div class="col-sm-4">
       <?php echo @$hasil_explode[3];?>
   </div>
</div>
<div class="form-group">
    <label class="col-sm-1">&nbsp&nbsp&nbsp e . </label>
    <div class="col-sm-4">
      <?php echo @$hasil_explode[4];?>
   </div>
</div>
</div>
<div class="form-group">
...
<?php
    ...
    if($user->kode_jabatan == "003"){
        ...
        if($hasil_data->posisi == "revisi paket"){
