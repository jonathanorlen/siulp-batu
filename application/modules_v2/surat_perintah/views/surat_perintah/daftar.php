                ...
                <div class="page page-hz-menu-layout">
                    ...
                    <div class="pageheader">
                        ...
                        <div class="page-bar">
                            ...
                            <ul class="page-breadcrumb">
                                ...
                                <li>
                                    <a href="<?php echo base_url() . 'surat_perintah/'?>">Surat Perintah Tugas</a>
                                </li>
                            </ul>
                    ...
                    <section class="tile">
                        ...
                        <div class="tile-header dvd dvd-btm">
                            <h1 class="custom-font">Data&nbsp<strong>Surat Perintah</strong></h1>
                            <ul class="controls">
                                <li class="dropdown">
                                    ...
                                    <tbody>
                                        ...
                                        foreach ($hasil_ambil as $item) {
                                            ...
                                            <td>
                                                ...
                                                <a href="#" class="btn btn-primary btn-rounded btn-ef btn-ef-5 btn-ef-5b mb-10"><span class="fa fa-print"> Cetak</span><i class="fa fa-print "></i></a>
                                            </td>
                                        </tr>
