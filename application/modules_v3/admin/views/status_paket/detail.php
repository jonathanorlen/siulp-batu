                    ...
                    <div class="pageheader">
                        ...
                        <div class="page-bar">
                            ...
                            <ul class="page-breadcrumb">
                                ...
                                <li>
                                    <a href="<?php echo base_url() . 'admin/status_paket/content'?>">Kelompok Kerja</a>
                                </li>
                                <li>
                                    <a>Detail Satus Paket</a>
                                </li>
                            </ul>
                        ...
                        <div class="col-md-12">
                            <section class="tile">
                                ...
                                <div class="tile-header dvd dvd-btm">
                                    <h1 class="custom-font"><strong>Detail&nbsp</strong>Status Paket</h1>
                                </div>
                                <!-- /tile header -->
                                ...
                                <div class="tile-body">
                                    ...
                                    <?php 
                                    $id = $_GET['id_status'];
                                    $ambil_data = $this->db->get_where('master_status_paket',array('id'  =>  $id));
                                    ...
                                    <form class="form-horizontal" name="data_form" role="form" method="post" id="data_form" data-parsley-validate action="">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-8">
                                                <input disabled="" type="text" name="status" class="form-control" disabled="" value="<?php echo $hasil_ambil_data->status?>" placeholder="Masukkan Nip" required="">
                                            </div>
                                        </div>
