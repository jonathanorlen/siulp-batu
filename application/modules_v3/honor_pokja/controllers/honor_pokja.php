...
class honor_pokja extends MY_Controller {
	...
	{	
		$data['menu'] = 'master';
		$data['konten'] = $this->load->view('honor_pokja/honor_pokja/jadwal_rapat', NULL, TRUE);
		$this->load->view ('main', $data);
	}
...
//jadwal rapat------------------------------------------------------------------------------------//
	...
	{	
		$data['menu'] = 'master';
		$data['konten'] = $this->load->view('honor_pokja/honor_pokja/detail', NULL, TRUE);
		$this->load->view ('main', $data);
	}
