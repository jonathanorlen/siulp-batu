                    ...
                    <div class="pageheader">
                        ...
                        <div class="page-bar">
                            ...
                            <ul class="page-breadcrumb">
                                ...
                                <li>
                                    <a href="<?php echo base_url() . 'honor_pokja/data_honor_pokja'?>">Data Honor POKJA</a>
                                </li>
                                <li>
                                    <a href="#" >Detail Paket Data Honor POKJA</a>
                                </li>
                            </ul>
                        ...
                        <div class="col-md-12">
                            <section class="tile">
                                ...
                                <div class="tile-header dvd dvd-btm">
                                    <h1 class="custom-font"><strong>Detail&nbsp</strong>Honor Pokja</h1>
                                </div>
                                <!-- /tile header -->
                                ...
                                <div class="tile-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-8">
                                            <input readonly type="date" name="tanggal_pengajuan" value="<?php echo TanggalIndo($hasil_data->tanggal_pengajuan);?>" class="form-control" placeholder="Masukkan Tanggal Pengajuan"
