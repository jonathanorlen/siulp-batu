                ...
                <div class="page page-hz-menu-layout">
                    ...
                    <div class="pageheader">
                        ...
                        <div class="page-bar">
                            ...
                            <ul class="page-breadcrumb">
                                ...
                                <li>
                                    <a href="<?php echo base_url() . 'admin/create_paket/content'?>">Input Hasil Lelang</a>
                                </li>
                            </ul>
                    ...
                    <section class="tile">
                        ...
                        <div class="tile-header dvd dvd-btm">
                            <h1 class="custom-font">Input&nbsp<strong> Hasil Lelang</strong></h1>
                            <ul class="controls">
                                <li class="dropdown">
                                    ...
                                    <div id="cari_status">
                                        <table style="font-size: small;" class="table table-hover table-custom dt-responsive" id="responsive-usage">
                                            ...
                                            <tbody>
                                                ...
                                                $hasil=$this->db->get_where("transaksi_data_paket",array('tutup_tahun'=>'Open','status_paket'=>'Input Hasil Lelang'));
                                        //echo $this->db->last_query();
                                                ...
                                                <!--<a href="<?php echo base_url().'admin/create_paket/ubah/'.$item->id;?>" title="Ubah"  class="btn btn-warning btn-rounded btn-icon-only btn-ef btn-ef-7 btn-ef-7c mb-10" style="position:relative;padding:10px 15px"><i class="fa fa-pencil" style="font-size:15px;position:relative;line-height:10px"></i></a>
                                                 ...
                                                 <?php if ($item->posisi != 'selesai' OR $item->posisi !='hasil lelang'){ 
                                                    if($user->kode_jabatan=="002"){    
                                                        ?>
                                                        <a href="<?php echo base_url().'admin/create_paket/ubah/'.$item->id;?>" title="Ubah"  class="btn btn-warning btn-rounded btn-icon-only btn-ef btn-ef-7 btn-ef-7c mb-10" style="position:relative;padding:10px 15px"><i class="fa fa-pencil" style="font-size:15px;position:relative;line-height:10px"></i></a>
                                                        <?php } } ?>
                                                        <a href="<?php echo base_url().'record_lelang/record_lelang/verifikasi/'.$item->kode_paket;?>" title="Input Hasil Lelang" class="btn bg-blue btn-rounded btn-icon-only btn-ef btn-ef-7 btn-ef-7c mb-10" style="position:relative;padding:10px 15px"><i class="fa fa-pencil-square-o"  style="font-size:15px;position:relative;line-height:10px"></i></a>
                                                    </td>
                                                </tr>
