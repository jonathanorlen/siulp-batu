                                    ...
                                    <tbody>
                                        ...
                                        foreach ($hasil_ambil as $item) {
                                            ...
                                            <tr>
                                             ...
                                             <td>
                                                <a href="<?php echo base_url().'rapat/notulen/detail?id='.$item->id;?>"><button class="btn btn-warning btn-rounded btn-ef btn-ef-5 btn-ef-5b mb-10"><span>Ubah</span><i class="fa fa-pencil"></i></button></a>
                                            </td>
                                        </tr>
