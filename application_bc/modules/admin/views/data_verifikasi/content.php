                                    ...
                                    <tbody>
                                        ...
                                        foreach ($hasil_ambil as $item) {
                                            ...
                                            <td>
                                                ...
                                                {
                                                    ?>
                                                    <a href="<?php echo base_url(). 'admin/data_verifikasi/detail/'. $item->id;?>" class="btn btn-success btn-sm btn-rounded btn-ef btn-ef-5 btn-ef-5b mb-10"><span>Verifikasi</span><i class="fa fa-pencil "></i></a>
                                                <?php 
                                                    }
                                                else if($item->status == 'terima')
                                                {
                                                    ?>
                                                    <a href="<?php echo base_url(). 'admin/data_verifikasi/detail_verifikasi/'. $item->id;?>" class="btn btn-warning btn-sm btn-rounded btn-ef btn-ef-5 btn-ef-5b mb-10"><span>Detail</span><i class="fa fa-eye"></i></a>
                                                    <a href="<?php echo base_url(). 'admin/data_verifikasi/cetak/'. $item->id;?>" class="btn btn-warning btn-sm btn-rounded btn-ef btn-ef-5 btn-ef-5b mb-10" target="_blank" style="background-color: #3376da"><span>Print</span><i class="fa fa-print" style="background-color: #3376da"></i></a>
                                                    <a href="<?php echo base_url(). 'admin/data_verifikasi/setting/'. $item->id;?>" class="btn btn-cyan btn-sm btn-rounded btn-ef btn-ef-5 btn-ef-5b mb-10" ><span>Setting Pokja</span><i class="fa fa-eye" style=""></i></a>
                                                <?php 
                                                    }else{
                                                ?>
                                                    <a href="<?php echo base_url(). 'admin/data_verifikasi/detail_verifikasi/'. $item->id;?>" class="btn btn-warning btn-sm btn-rounded btn-ef btn-ef-5 btn-ef-5b mb-10"><span>Detail</span><i class="fa fa-eye"></i></a>
