                        ...
                        <div class="col-md-12">
                            <section class="tile" >
                                ...
                                <div class="tile-header dvd dvd-btm">
                                    <h1 class="custom-font"><strong>Verfikasi Data Paket</strong></h1>
                                </div>
                                <!-- /tile header -->
                                ...
                                <div class="tile-body" >
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-8">
                                            <input readonly type="text" value="<?php echo format_rupiah($hasil_data->pagu);?>" class="form-control" placeholder="Pagu"
                                            data-parsley-trigger="change"
                                            />
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-8">
                                            <input readonly type="text" value="<?php echo format_rupiah($hasil_data->hps);?>" class="form-control" placeholder="HPS"
                                            data-parsley-trigger="change"
                                            />
