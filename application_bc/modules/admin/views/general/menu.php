                                ...
                                <div id="sidebarNav" class="panel-collapse collapse in" role="tabpanel">
                                    <div class="panel-body">
                                        ...
                                        <ul id="navigation">
                                            ...
                                            ?>
                                            <li>
                                                <a href="#"><i class="fa fa-list "></i><span>Data Paket</span><span  class="badge bg-lightred"><?php if(!empty($hasil_gabung)){ ;?><?php echo count($hasil_gabung);?><?php } ?><!-- </span>
                                                    <span class="badge bg-lightred"><?php if(!empty($hasil_ambil)){ ;?><?php echo count($hasil_ambil);?><?php } ?></span> --></a>
                                                    <ul>
                                                        <li><a href="<?php echo base_url() . 'admin/create_paket/content'?>"><i class="fa fa-caret-right"></i><i class="fa fa-plus-square"></i> Data Paket<span  class="badge bg-warning"><?php if(!empty($hasil_tolak)){ ;?><?php echo count($hasil_tolak);?><?php } ?></span></a></li>
                                                        ...
                                                        <li><a href="<?php echo base_url() . 'admin/data_verifikasi/content'?>"><i class="fa fa-caret-right"></i><i class="fa fa-check-square"></i> Verifikasi <span class="badge bg-lightred"><?php if(!empty($hasil_ambil)){ ;?><?php echo count($hasil_ambil);?><?php } ?></span></a></li>
                                                        
                                                    </ul>
                                                </li>
                                                <li class="<?php if(@$menu=="rapat"){ echo "active"; } ?>">
                                                 <?php
                                                   $hasil = $this->db->query(" SELECT * FROM transaksi_rapat where status_rapat = 'terima' ");
                                                   $hasil_jadwal = $hasil->result();
                                                   ?>
                                                   ...
                                                   <ul>
                                                    ...
                                                    <li><a href="<?php echo base_url() . 'rapat/rapat/content/'?>"><i class="fa fa-caret-right"></i><i class="fa fa-plus-square"></i> Data Rapat</a></li>
                                                    <li><a href="<?php echo base_url() . 'rapat/rapat/jadwal_rapat/'?>"><i class="fa fa-caret-right"></i><i class="fa fa-calendar"></i> Jadwal Rapat<span  class="badge bg-success"><?php if(!empty($hasil_jadwal)){ ;?><?php echo count($hasil_jadwal);?><?php } ?></span></a></li>
                                                    <li><a href="<?php echo base_url() . 'rapat/notulen/content'?>"><i class="fa fa-caret-right"></i><i class="fa fa-align-justify"></i> Notulensi</a></li>
                                                </ul>
                                            </li>
