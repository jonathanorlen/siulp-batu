                        ...
                        <div class="col-md-12">
                            <section class="tile">
                                ...
                                <div class="tile-header dvd dvd-btm">
                                    <h1 class="custom-font"><strong>Detail&nbsp</strong>Metode Pengadaan</h1>
                                </div>
                                <!-- /tile header -->
                                ...
                                <div class="tile-body">
                                    ...
                                    <form class="form-horizontal" name="data_form" role="form" method="post" id="data_form" data-parsley-validate action="">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-8">
                                                <input disabled="" type="hidden" name="id" class="form-control" disabled="" value="<?php echo $hasil_ambil_data->id?>" placeholder="Masukkan Nip" required="">
                                                <input disabled="" type="text" name="jenis_pengadaan" class="form-control" disabled="" value="<?php echo $hasil_ambil_data->metode_pengadaan?>" placeholder="Metode Pengadaan" required="">
                                            </div>
                                        </div>
