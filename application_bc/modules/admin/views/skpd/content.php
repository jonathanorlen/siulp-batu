                                    ...
                                    <tbody>
                                        ...
                                        foreach ($hasil_ambil as $item) {
                                            ...
                                            <tr>
                                             ...
                                             <td>
                                                <a href="<?php echo base_url().'admin/skpd/detail?id_satuan='.$item->id;?>"><button class="btn btn-success btn-rounded btn-ef btn-ef-5 btn-ef-5b mb-10"><span>Detail</span><i class="fa fa-eye"></i></button></a>
                                                <a href="<?php echo base_url().'admin/skpd/ubah?id_satuan='.$item->id;?>">
