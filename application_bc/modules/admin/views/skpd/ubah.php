                        ...
                        <div class="col-md-12">
                            <section class="tile">
                                ...
                                <div class="tile-header dvd dvd-btm">
                                    <h1 class="custom-font"><strong>Detail&nbsp</strong>Satuan Kerja</h1>
                                </div>
                                <!-- /tile header -->
                                ...
                                <div class="tile-body">
                                    ...
                                    ?>
                                    <form class="form-horizontal" name="data_form" role="form" method="post" id="data_form" data-parsley-validate action="<?php echo base_url().'admin/skpd/simpan_ubah'?>">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-8">
                                             ...
                                             <input type="text" name="kode_skpd" class="form-control" value="<?php echo $hasil_ambil_data->kode_skpd?>" placeholder="Masukkan Nama"
                                     ...
                                     <div class="form-group">
                                        ...
                                        <div class="col-sm-8">
                                         <input type="text" name="unit_kerja" class="form-control" value="<?php echo $hasil_ambil_data->unit_kerja?>" placeholder="Masukkan Nip" required="">
                                     </div>
                                 </div>
                                 ...
                                 <div class="form-group">
                                    ...
                                    <div class="col-sm-8">
                                        <input type="text" name="kepala" class="form-control" value="<?php echo $hasil_ambil_data->kepala?>" placeholder="Masukkan Nama"
                                        data-parsley-trigger="change"
                                        required>
                                    </div>
                                </div>
