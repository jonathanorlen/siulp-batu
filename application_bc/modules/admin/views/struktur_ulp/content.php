                ...
                <div class="page page-hz-menu-layout">
                    ...
                    <section class="tile">
                        ...
                        <div class="tile-header dvd dvd-btm">
                            <h1 class="custom-font">Data&nbsp<strong>Struktur ULP</strong></h1>
                            <ul class="controls">
                                <li class="dropdown">
                        ...
                        <div class="table-responsive">
                            ...
                            <table class="table table-hover table-custom dt-responsive" id="responsive-usage">
                                ...
                                <tbody>
                        <?php
                            $hasil=$this->db->get("master_struktur_ulp");
                        ...
                        ?>
                                   ...
                                   <td><?php echo $no;?></td>
                                    ...
                                    <td>
                                        <a href="<?php echo base_url(). 'admin/struktur_ulp/detail/'. $item->id;?>" class="btn btn-success btn-rounded btn-ef btn-ef-5 btn-ef-5b mb-10"><span>Detail</span><i class="fa fa-eye"></i></a>
                                        <a href="<?php echo base_url(). 'admin/struktur_ulp/ubah?id='. $item->id;?>" class="btn btn-warning btn-rounded btn-ef btn-ef-5 btn-ef-5b mb-10"><span>Edit</span><i class="fa fa-pencil"></i></a>
                                        ...
                                        <!--<a href="<?php echo base_url(). 'admin/struktur_ulp/hapus?id='. $item->id;?>" class="btn btn-danger btn-rounded btn-ef btn-ef-5 btn-ef-5b mb-10"><span>Delete</span><i class="fa fa-trash"></i></a>-->
                                    </td>
                                   </tr>
