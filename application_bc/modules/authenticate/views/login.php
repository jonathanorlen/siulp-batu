...
.form-control.underline-input:focus:hover {
    ...
    border-bottom: 1px solid #22beef;
            ...
            <div class="page page-core page-login">
                ...
                <div class="text-center"><h3 class="text-light text-white"><span class="text-lightred">Siulp</span> &nbsp Batu</h3></div>
                ...
                <div class="container w-420 p-15 bg-white mt-40 text-center">
                    ...
                    <div class="bg-slategray lt wrap-reset mt-40">
                        <p class="m-0">
                            <a href="http://cloud-astro.com/" target="_Blank" class="text-uppercase"><?php echo date("Y"); ?> - Cloud Astro</a>
                        </p>
                    </div>
