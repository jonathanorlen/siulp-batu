<script type="text/javascript">
  $(function () {
    ...
    $("#data_form").submit( function() {    
      $.ajax( {  
        type :"post",  
        url : "<?php echo base_url() . 'admin/layanan/simpan_tambah' ?>",  
        cache :false,  
        data :$(this).serialize(),
        success : function(data) {  
          $(".sukses").html(data);   
          setTimeout(function(){$('.sukses').html('');window.location = "<?php echo
base_url() . 'admin/layanan/daftar' ?>";},1500);              
        },  
        error : function() {  
          ...
          <div class="box-body">            
            ...
            <form method="post" id="data_form">
              <div class="form-group">
                ...
                <input type="text" class="form-control" name="judul" placeholder="Nama Layanan" />
              </div>  
              ...
              <div>
                ...
                <textarea name="isi" placeholder="Deskripsi Layanan" style="width: 100%; height: 300px; font-size: 14px; line-height: 18px; border: 1px solid #dddddd; padding: 10px;"></textarea>
              </div>
